...
our %config = (
  ...
  CFLAGS => [ "-Os -fomit-frame-pointer -fno-stack-protector -femit-struct-debug-baseonly -fno-var-tracking -pipe  -DEMBED -I/opt/padavan-ng/trunk/stage/include -Dlinux -D__linux__ -Dunix -Wall -Wno-trigraphs -Wno-strict-aliasing -Wno-format-security -Wno-unused-but-set-variable -Wno-unused-const-variable -Wno-format-truncation -Wno-format-overflow -Wno-misleading-indentation -fconserve-stack -fno-strict-overflow -fno-var-tracking-assignments -fno-merge-all-constants -fmerge-constants -fno-stack-check -fno-delete-null-pointer-checks -Wno-pointer-sign -ffunction-sections -fdata-sections", "-Os", "-fomit-frame-pointer", "-fno-stack-protector", "-femit-struct-debug-baseonly", "-fno-var-tracking", "-pipe", "-Wall", "-Wno-trigraphs", "-Wno-strict-aliasing", "-Wno-format-security", "-Wno-unused-but-set-variable", "-Wno-unused-const-variable", "-Wno-format-truncation", "-Wno-format-overflow", "-Wno-misleading-indentation", "-fconserve-stack", "-fno-strict-overflow", "-fno-var-tracking-assignments", "-fno-merge-all-constants", "-fmerge-constants", "-fno-stack-check", "-fno-delete-null-pointer-checks", "-Wno-pointer-sign", "-ffunction-sections", "-fdata-sections", "-Os" ],
  CPPDEFINES => [ "EMBED", "linux", "__linux__", "unix", "OPENSSL_USE_IPV6=1", "OPENSSL_SMALL_FOOTPRINT", "OPENSSL_PREFER_CHACHA_OVER_GCM" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [ "/opt/padavan-ng/trunk/stage/include" ],
  CROSS_COMPILE => "/opt/padavan-ng/trunk/../toolchain/out/bin/mipsel-linux-uclibc-",
  CXX => "g++ -mips32r2 -march=mips32r2 -mtune=1004kc",
  CXXFLAGS => [ "-Os -fomit-frame-pointer -fno-stack-protector -femit-struct-debug-baseonly -fno-var-tracking -pipe  -DEMBED -I/opt/padavan-ng/trunk/stage/include -Dlinux -D__linux__ -Dunix -Wall -Wno-trigraphs -Wno-strict-aliasing -Wno-format-security -Wno-unused-but-set-variable -Wno-unused-const-variable -Wno-format-truncation -Wno-format-overflow -Wno-misleading-indentation -fconserve-stack -fno-strict-overflow -fno-var-tracking-assignments -fno-merge-all-constants -fmerge-constants -fno-stack-check -fno-delete-null-pointer-checks  -static-libstdc++", "-Os", "-fomit-frame-pointer", "-fno-stack-protector", "-femit-struct-debug-baseonly", "-fno-var-tracking", "-pipe", "-Wall", "-Wno-trigraphs", "-Wno-strict-aliasing", "-Wno-format-security", "-Wno-unused-but-set-variable", "-Wno-unused-const-variable", "-Wno-format-truncation", "-Wno-format-overflow", "-Wno-misleading-indentation", "-fconserve-stack", "-fno-strict-overflow", "-fno-var-tracking-assignments", "-fno-merge-all-constants", "-fmerge-constants", "-fno-stack-check", "-fno-delete-null-pointer-checks", "-Wno-pointer-sign", "-ffunction-sections", "-fdata-sections", "-Os" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "-L/opt/padavan-ng/trunk/stage/lib -Wl,--gc-sections", "-Wl,--gc-sections", "-L/opt/padavan-ng/trunk/stage/lib" ],
  LDLIBS => [  ],
  PERL => "/usr/bin/perl",
  RANLIB => "ranlib",
  RC => "windres",
  ...
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_ARIA", "OPENSSL_NO_BLAKE2", "OPENSSL_NO_CAST", "OPENSSL_NO_CMS", "OPENSSL_NO_IDEA", "OPENSSL_NO_MD2", "OPENSSL_NO_MDC2", "OPENSSL_NO_RC5", "OPENSSL_NO_RMD160", "OPENSSL_NO_SEED", "OPENSSL_NO_SM2", "OPENSSL_NO_SM3", "OPENSSL_NO_SM4", "OPENSSL_NO_SRP", "OPENSSL_NO_TS", "OPENSSL_NO_WHIRLPOOL" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASYNC", "OPENSSL_NO_CAPIENG", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_DSO", "OPENSSL_NO_EC2M", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_EGD", "OPENSSL_NO_ERR", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_HW", "OPENSSL_NO_HW_PADLOCK", "OPENSSL_NO_MSAN", "OPENSSL_NO_RFC3779", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "/etc/ssl",
  options => "enable-shared --prefix=/ --openssldir=/etc/ssl -Os -fomit-frame-pointer -fno-stack-protector -femit-struct-debug-baseonly -fno-var-tracking -pipe -DEMBED -I/opt/padavan-ng/trunk/stage/include -Dlinux -D__linux__ -Dunix -Wall -Wno-trigraphs -Wno-strict-aliasing -Wno-format-security -Wno-unused-but-set-variable -Wno-unused-const-variable -Wno-format-truncation -Wno-format-overflow -Wno-misleading-indentation -fconserve-stack -fno-strict-overflow -fno-var-tracking-assignments -fno-merge-all-constants -fmerge-constants -fno-stack-check -fno-delete-null-pointer-checks -Wno-pointer-sign -ffunction-sections -fdata-sections -Os -DOPENSSL_USE_IPV6=1 -DOPENSSL_SMALL_FOOTPRINT -DOPENSSL_PREFER_CHACHA_OVER_GCM -Wl,--gc-sections -L/opt/padavan-ng/trunk/stage/lib no-afalgeng no-aria no-asan no-async no-blake2 no-buildtest-c++ no-capieng no-cast no-cms no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dso no-dynamic-engine no-ec2m no-ec_nistp_64_gcc_128 no-egd no-err no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-hw-padlock no-idea no-md2 no-mdc2 no-msan no-rc5 no-rfc3779 no-rmd160 no-sctp no-seed no-sm2 no-sm3 no-sm4 no-srp no-sse2 no-ssl-trace no-ssl3 no-ssl3-method no-ts no-ubsan no-unit-test no-weak-ssl-ciphers no-whirlpool no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.26.1",
  perlargv => [ "linux-mips32", "shared", "--prefix=/", "--openssldir=/etc/ssl", "-Os", "-fomit-frame-pointer", "-fno-stack-protector", "-femit-struct-debug-baseonly", "-fno-var-tracking", "-pipe", "-DEMBED", "-I/opt/padavan-ng/trunk/stage/include", "-Dlinux", "-D__linux__", "-Dunix", "-Wall", "-Wno-trigraphs", "-Wno-strict-aliasing", "-Wno-format-security", "-Wno-unused-but-set-variable", "-Wno-unused-const-variable", "-Wno-format-truncation", "-Wno-format-overflow", "-Wno-misleading-indentation", "-fconserve-stack", "-fno-strict-overflow", "-fno-var-tracking-assignments", "-fno-merge-all-constants", "-fmerge-constants", "-fno-stack-check", "-fno-delete-null-pointer-checks", "-Wno-pointer-sign", "-ffunction-sections", "-fdata-sections", "-Os", "-DOPENSSL_USE_IPV6=1", "-DOPENSSL_SMALL_FOOTPRINT", "-DOPENSSL_PREFER_CHACHA_OVER_GCM", "-Wl,--gc-sections", "-L/opt/padavan-ng/trunk/stage/lib", "no-capieng", "no-cms", "no-rfc3779", "no-seed", "no-async", "no-ec2m", "no-err", "no-idea", "no-rc5", "no-rmd160", "no-blake2", "no-static-engine", "no-hw-padlock", "no-md2", "no-sse2", "no-dso", "no-ts", "no-mdc2", "no-cast", "no-whirlpool", "no-sctp", "no-srp", "no-ssl3", "no-aria", "no-sm2", "no-sm3", "no-sm4", "no-hw", "no-devcryptoeng" ],
  perlenv => {
      "AR" => "ar",
      "BUILDFILE" => undef,
      "CC" => "gcc -mips32r2 -march=mips32r2 -mtune=1004kc",
      "CFLAGS" => "-Os -fomit-frame-pointer -fno-stack-protector -femit-struct-debug-baseonly -fno-var-tracking -pipe  -DEMBED -I/opt/padavan-ng/trunk/stage/include -Dlinux -D__linux__ -Dunix -Wall -Wno-trigraphs -Wno-strict-aliasing -Wno-format-security -Wno-unused-but-set-variable -Wno-unused-const-variable -Wno-format-truncation -Wno-format-overflow -Wno-misleading-indentation -fconserve-stack -fno-strict-overflow -fno-var-tracking-assignments -fno-merge-all-constants -fmerge-constants -fno-stack-check -fno-delete-null-pointer-checks -Wno-pointer-sign -ffunction-sections -fdata-sections",
      "CPPFLAGS" => undef,
      "CROSS_COMPILE" => "/opt/padavan-ng/trunk/../toolchain/out/bin/mipsel-linux-uclibc-",
      "CXX" => "g++ -mips32r2 -march=mips32r2 -mtune=1004kc",
      "CXXFLAGS" => "-Os -fomit-frame-pointer -fno-stack-protector -femit-struct-debug-baseonly -fno-var-tracking -pipe  -DEMBED -I/opt/padavan-ng/trunk/stage/include -Dlinux -D__linux__ -Dunix -Wall -Wno-trigraphs -Wno-strict-aliasing -Wno-format-security -Wno-unused-but-set-variable -Wno-unused-const-variable -Wno-format-truncation -Wno-format-overflow -Wno-misleading-indentation -fconserve-stack -fno-strict-overflow -fno-var-tracking-assignments -fno-merge-all-constants -fmerge-constants -fno-stack-check -fno-delete-null-pointer-checks  -static-libstdc++",
      "HASHBANGPERL" => undef,
      "LDFLAGS" => "-L/opt/padavan-ng/trunk/stage/lib -Wl,--gc-sections",
      "LDLIBS" => undef,
  ...
  sdirs => [ "objects", "md4", "md5", "sha", "hmac", "poly1305", "siphash", "des", "aes", "rc2", "rc4", "bf", "camellia", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "dso", "engine", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
