/* Xiaomi Mi 4A_100M_BREED (R4A-100M)*/

#define BOARD_PID		"MI-4A_100M_BREED"
#define BOARD_NAME		"MI-4A_100M_BREED"
#define BOARD_DESC		"Xiaomi Mi 4A_100M_BREED Wireless Router"
