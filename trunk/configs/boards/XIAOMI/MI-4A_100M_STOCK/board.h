/* Xiaomi Mi 4A_100M_STOCK (R4A-100M)*/

#define BOARD_PID		"MI-4A_100M_STOCK"
#define BOARD_NAME		"MI-4A_100M_STOCK"
#define BOARD_DESC		"Xiaomi Mi 4A_100M_STOCK Wireless Router"
