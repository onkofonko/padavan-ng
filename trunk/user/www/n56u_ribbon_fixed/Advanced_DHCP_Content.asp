                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            <th colspan="2" width="50%"><a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,5,14);"><#LANHostConfig_ManualDHCPEnable_itemname#></a></th>
                                            <td colspan="2">
                                                <div class="main_itoggle">
                                        ...
                                        <tr id="row_static_arp" style="display:none">
                                            <th colspan="2" width="50%"><a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,5,15);"><#LANHostConfig_ManualARP_itemname#></a></th>
                                            <td colspan="2">
                                                <div class="main_itoggle">
