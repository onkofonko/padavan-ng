...
Currently available applets include:
	...
	addgroup, adduser, arp, arping, ash, awk, base32, basename, bash,
	brctl, bunzip2, bzcat, bzip2, cat, chgrp, chmod, chown, chpasswd,
	chroot, clear, cp, crond, crontab, cut, date, dd, df, dirname,
...
tar c|x|t [-zjahvokO] [-f TARFILE] [-C DIR] [-T FILE] [-X FILE] [OPTION]... [FILE]...
