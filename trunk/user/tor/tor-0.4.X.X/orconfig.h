...
/* # for 0.4.5.7 Approximate date when this software was released. (Updated
   when the version changes.) */
#define APPROX_RELEASE_DATE "2021-03-15"

/* tor's build directory */
#define BUILDDIR "/opt/padavan-ng/trunk/user/tor/tor-0.4.X.X"

/* tor's configuration directory */
#define CONFDIR "/etc/storage/tor"
...
#define PACKAGE_STRING "tor 0.4.5.7"
...
#define PACKAGE_VERSION "0.4.5.7"
...
#define SRCDIR "/opt/padavan-ng/trunk/user/tor/tor-0.4.X.X"
